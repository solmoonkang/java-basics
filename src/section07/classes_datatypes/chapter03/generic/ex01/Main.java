package section07.classes_datatypes.chapter03.generic.ex01;

import section05.oop.chapter08.abstractclass.ex01.YalcoChicken;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        double randDbl = pickRandom(12, 34);    //  -> 정수는 실수로 묵시적 변환이 되므로 에러가 발생하지는 않는다.
