package section03.datatypes_operators.chapter08.array;
...
public class Ex01 {
    public static void main(String[] args) {
        ...
        //  💡 초기화하지 않고 일단 선언하기
        //  ⭐ 어떤 값으로 초기화되는지 확인
        boolean[] boolAry = new boolean[3];         // boolean은 1Byte로 총 3Byte로 구성된 배열을 생성
        int[] intAry = new int[3];                  // 그 이외의 자료형들 또한 마찬가지로 생성
